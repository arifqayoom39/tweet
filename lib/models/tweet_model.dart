...
import 'package:twitter_clone/core/enums/tweet_type_enum.dart';  // Ensure this path is correct
...
class Tweet {
  ...
  final String uid;
  final TweetType tweetType;  // Capitalize to match enum definition
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'uid': uid,
      'tweetType': tweetType.type,  // Use 'type' from enum
  ...
  factory Tweet.fromMap(Map<String, dynamic> map) {
    return Tweet(
      ...
      uid: map['uid'] ?? '',
      tweetType: (map['tweetType'] as String).toTweetTypeEnum(),  // Use extension to convert to enum
